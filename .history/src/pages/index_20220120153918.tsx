    ...
    <div id={styles.rooter}>
      ...
      <div id={styles.flexBox}>
        ...
        <div id={styles.rightFlexChild}>
          ...
          <div id={styles.fatherIcons}>
            <div className={styles.weIcons}>
              <WechatOutlined />
            </div>
            <div className={styles.qqIcons}>
              <QqOutlined />
            </div>
          </div>
          <div id={styles.iconText}>
            <span id={styles.weText}>weChat account:hanson0327</span>
            <span id={styles.qqText}>qq account:1550171965</span>
          </div>
        </div>
      </div>
